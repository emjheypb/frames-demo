...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "fc:frame:button:1:post_url": `${process.env.NEXT_PUBLIC_BASE_URL}/api/frame?id=1`,
    "fc:frame:button:2": `PLAY ROCK, PAPER, SCISSORS`,
    "fc:frame:button:2:post_url": `${process.env.NEXT_PUBLIC_BASE_URL}/api/under-construction`,
  },
};
